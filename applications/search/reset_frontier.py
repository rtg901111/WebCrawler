...
from datamodel.search.Sanghuk2Newmanc1Carletoz_datamodel import Sanghuk2Newmanc1CarletozLink
...
@Deleter(Sanghuk2Newmanc1CarletozLink)
@Getter(Sanghuk2Newmanc1CarletozLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Sanghuk2Newmanc1CarletozLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Sanghuk2Newmanc1CarletozLink, l)
...
class Simulation(object):
    ...
    def __init__(self, address, port):
        ...
        objectless_connector = ObjectlessSpacetimeConnection(
            "ResetFrontier_Sanghuk2Newmanc1Carletoz".format(CrawlerFrame.app_id),
